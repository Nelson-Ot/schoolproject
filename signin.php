                            ...
                            <div class="l-f-o__pad-box">
                                ...
                                <form class="l-f-o__form" action="" method="POST">
                                    ...
                                    <div class="u-s-m-b-30">
                                        ...
                                        <input class="input-text input-text--primary-style" type="text" id="login-email" placeholder="Enter your username" name="uname">
                                    </div>
                                    <div class="u-s-m-b-30">

                                        <label class="gl-label" for="login-password">PASSWORD *</label>

                                        <input class="input-text input-text--primary-style" type="password" id="login-password" placeholder="Enter Password" name="upassword">
                                    </div>
                                    <div class="gl-inline">
                                        <div class="u-s-m-b-30">
