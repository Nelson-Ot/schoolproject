...
<div class="app-content">
    <?php
    if (isset($_GET['prod'])) {
        $selk = $conn->query("select * from products where id=" . $_GET['prod'] . "")->fetch_assoc();
    ?>
                            ...
                            <ul class="pd-breadcrumb__list">
                                ...
                                <li class="has-separator">
                                    ...
                                    <a href="shop-side-version-2.html">
                                        <?php $cat = $conn->query("select * from product_category where cat_id=" . $selk['catnameid'] . "")->fetch_assoc();
                                        echo $cat['cat_name']; ?>
                                    </a>
                                </li>
                                <li class="has-separator">
                                    ...
                                    <a href="shop-side-version-2.html">
                                        <?php $scat = $conn->query("select * from sub_cat where subcatid=" . $selk['subcatname'] . "")->fetch_assoc();
                                        echo $scat['sub_cat_name']; ?>
                                    </a>
                                </li>
                                <li class="is-marked">

                                    <a href=""><?php echo $selk['pname']; ?></a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="pd u-s-m-b-30">
                            <div class="slider-fouc pd-wrap">
                                <div id="pd-o-initiate">
                                    <div class="pd-o-img-wrap" data-src="dashboard/admin/<?php echo $selk['pimg']; ?>">

                                        <img class="u-img-fluid" src="dashboard/admin/<?php echo $selk['pimg']; ?>" data-zoom-image="dashboard/admin/<?php echo $selk['pimg']; ?>" alt="">
                                    </div>
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="pd-detail">
                            <div>
                                ...
                                <span class="pd-detail__name"><?php echo $selk['pname']; ?></span>
                            </div>
                            <div>
                                <div class="pd-detail__inline">

                                    <span class="pd-detail__price">Ksh <?php echo $selk['pprice']; ?></span>

                                    <span class="pd-detail__discount">(<?php echo $selk['discount']; ?> OFF)</span><del class="pd-detail__del">Kshs<?php if ($selk['discount'] == 0) {
                                                                                                                                                        echo "00";
                                                                                                                                                    } else {
                                                                                                                                                        $tp = $selk['pprice'];
                                                                                                                                                        $dis = 100 - $selk['discount'];
                                                                                                                                                        $total = 100 * ($tp / $dis);
                            ...
                            <div class="u-s-m-b-15">
                                ...
                                <span class="pd-detail__preview-desc"><?php echo $selk['pdesc']; ?></span>
                            </div>
                            <div class="u-s-m-b-15">
                                <div class="pd-detail__inline">
                                ...
                                <form class="pd-detail__form">
                                    <div class="pd-detail-inline-2">
                                        <div class="u-s-m-b-15">
                                            ...
                                            <a href="tel:<?php $usr = $conn->query("select * from users where user_id=" . $selk['ucode'] . "")->fetch_assoc();
                                                            echo $usr['user_phone_number']; ?>" class="btn btn--e-brand-b-2">
                                                call to order
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade show active" id="pd-desc">
                                    <div class="pd-tab__desc">
                                        ...
                                        <?php if ($selk['product_info_question'] != NULL) { ?>

                                            <div class="u-s-m-b-15">

                                                <h4><?php echo "PRODUCTS SPECIFICATION"; ?></h4>
                                            </div>
                                            <div class="u-s-m-b-15">
                                                <div class="pd-table gl-scroll">
                                                    <table>
                                                        <tbody>
                                                            <?php
                                                            $products_a_row_product_info_question_Array = explode(',', $selk['product_info_question']);
                                                            $products_a_row_product_info_answer_Array = explode(',', $selk['product_info_answer']);
            ...
            <div class="container">
                <div class="slider-fouc">
                    <div class="owl-carousel product-slider" data-item="4">
                        <?php
                        $prdts = $conn->query("select * from products where catnameid=" . $row['cat_id'] . " order by id desc");


                        while ($res = $prdts->fetch_assoc()) {
                        ?>
                            <div class="u-s-m-b-30">
