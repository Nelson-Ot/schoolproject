                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="contact-area u-h-100">
                            ...
                            <form class="contact-f" method="post" action="">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 u-h-100">
                                        <div class="u-s-m-b-30">
                                            ...
                                            <input class="input-text input-text--border-radius input-text--primary-style" type="text" id="c-name" placeholder="Name (Required)" required name="c-name">
                                        </div>
                                        <div class="u-s-m-b-30">

                                            <label for="c-email"></label>

                                            <input class="input-text input-text--border-radius input-text--primary-style" type="text" id="c-email" placeholder="Email (Required)" required name="c-email" />
                                        </div>
                                        <div class="u-s-m-b-30">

                                            <label for="c-subject"></label>

                                            <input class="input-text input-text--border-radius input-text--primary-style" type="text" id="c-subject" placeholder="Subject (Required)" required name="c-subject">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 u-h-100">
                                        <div class="u-s-m-b-30">

                                            <label for="c-message"></label><textarea class="text-area text-area--border-radius text-area--primary-style" id="c-message" placeholder="Compose a Message (Required)" required name="c-message"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">

                                        <button class="btn btn--e-brand-b-2" type="submit" name="send_message">Send Message</button>
                                    </div>
                                </div>
                            </form>
                            <?php
                            if (isset($_POST['send_message'])) {
                                ...
                                $sql = "INSERT INTO feedbacks (cname,email,csubject,cmessage) VALUES('$name','$email','$subject','$message')";
