                    ...
                    <div class="shop-p">
                        ...
                        <div class="shop-p__collection">
                            <div class="row is-grid-active">
                                ...
                                $sp = $conn->query("select * from products WHERE (`pname` LIKE '%" . $search . "%') OR (`pdesc` LIKE '%" . $search . "%')");
                                
                                // $cnt = mysqli_num_row($sp);
                                // if ($cnt > 1) {
                                //     # code...
                                

                                while ($spr = $sp->fetch_assoc()) {; ?>
                                    <div class="col-lg-3 col-md-4 col-sm-6">
                                        <div class="product-m">
                                            <div class="product-m__thumb">

                                                <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail-affiliate.php<?php echo $spr['id']; ?>">

                                                    <img class="aspect__img" src="dashboard/admin/<?php echo $spr['pimg']; ?>" alt="product image"></a>
                                            ...
                                            <div class="product-m__content">
                                                <div class="product-m__category">
                                                    ...
                                                    <a href="">
                                                        <?php $usr = $conn->query("select * from users where user_id=" . $spr['ucode'] . "")->fetch_assoc();
                                                        echo $usr['uname']; ?>
                                                    </a>
                                                </div>
                                                <div class="product-m__name">

                                                    <a href="product-detail-affiliate.php<?php echo $spr['id']; ?>"><?php echo $spr['pname']; ?></a>
                                                </div>
                                                <div class="product-m__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i><i class="far fa-star"></i><i class="far fa-star"></i>

                                                    <span class="product-m__review">(23)</span>
                                                </div>
                                                <div class="product-m__price">Ksh <?php echo $spr['pprice']; ?></div>
                                                <div class="product-m__hover">
                                                    <div class="product-m__preview-description">

                                                        <span><?php echo $spr['pdesc']; ?></span>.</span>
                                                    </div>
                                ...
                                <div class="empty">
                                    <div class="empty__wrap">
                                        ...
                                        <form class="empty__search-form" method="get" action="shop-full-grid.php">
